...
class ReviewItem extends Component {
  ...
  componentDidMount() {
    ...
    let numbStars = Math.floor(review.rating);
      ...
      <div style={{padding: '15px 20px 25px'}}>
        <div className="row">
          <div className="col-md-1" style={{padding: '0 0 0'}}>
            <p style={{backgroundColor: 'lightcoral', width: '55px', height: '55px', borderRadius: '50%', display: 'flex', justifyContent: 'center', alignItems: 'center', fontSize: '160%', fontWeight: '500', color: 'white'}}>
              <img src={this.state.review.authorAvatarUrl}></img></p>
          </div>
          <div className="col-md-11" style={{padding: '0 0 0 25px'}}>
            <div className="row">
              <div className="col-sm-10 col-md-9">
                <p style={{fontSize: '125%', fontWeight: '500'}}>{this.state.review.authorName}</p>
